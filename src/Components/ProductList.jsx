            ...
            >
              <div>
                ...
                {amount === 0 ? (
                  ...
                  >
                    <img src="/public/Images/Icons/icon-add-to-cart.svg" /> Add
                    To Cart
                  </button>
                ) : (
                  <div className="flex justify-between items-center bg-orange-700 w-[165px] py-2 px-6 rounded-full mx-auto relative top-[-20px]">
                    ...
                    >
                      <img
                        src="/public/Images/Icons/icon-decrement-quantity.svg"
                        className="mx-auto"
                      />
                    </button>
                    ...
                    >
                      <img
                        src="/public/Images/Icons/icon-increment-quantity.svg"
                        className="mx-auto"
                      />
                    </button>
                  </div>
